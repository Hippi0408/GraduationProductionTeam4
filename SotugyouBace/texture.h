...
public: /* 定義 */
	...
	{	
		...
		/* スキル */
		TEXTURE_SKILL_RUSH,
		TEXTURE_SKILL_VANGUARD,
		TEXTURE_SKILL_EAGLEEYE,
		TEXTURE_SKILL_MARSHALL,
		TEXTURE_SKILL_MECHANIC,
		TEXTURE_SKILL_RAIDER,
		TEXTURE_SKILL_ARCPHILIA,
		TEXTURE_SKILL_CONTROL,
