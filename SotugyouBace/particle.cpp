...
// パーティクルのコンストラクタ
//＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
CParticle::CParticle(const CObject3D::PRIORITY priority) : CObject3D(priority),
	m_info({}),
	m_nTime(0)			// 時間
{
	m_mul = 0.25f;
...
void CParticle::Update()
{
	...
	D3DXVECTOR2 scale = CObject3D::GetScale();
...
void CParticle::processPath()
{
	...
	case 5:
		CObject3D::SetTexture(CTexture::TEXTURE_EFFECT_SHOCK);
		break;
