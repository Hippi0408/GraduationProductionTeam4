...
HRESULT CTitle::Init()
{
	...
	m_pTitle[0] = CObject2D::Create(D3DXVECTOR3(SCREEN_WIDTH * 0.5f - 200.0f, SCREEN_HEIGHT * 0.5f, 0.0f), D3DXVECTOR2(350.0f, 350.0f));
	m_pTitle[0]->SetTexture(CTexture::TEXTURE_TITLE_00);

	m_pTitle[1] = CObject2D::Create(D3DXVECTOR3(SCREEN_WIDTH * 0.5f + 200.0f, SCREEN_HEIGHT * 0.5f, 0.0f), D3DXVECTOR2(350.0f, 350.0f));
